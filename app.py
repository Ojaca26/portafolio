...
with st.sidebar:
    ...
    # --- CAMBIO: Pie de página RESTAURADO en el sidebar ---
        ...
        if img_iana_b64:
            st.markdown(
                ...
                <a href='https://iana-datainsightsco.com/' target='_blank' style='text-decoration: none;'>
                    <div style='display: flex; justify-content: center; align-items: center; min-height: 200px;'>
                        <img src='data:image/png;base64,{img_iana_b64}' width='470' style='max-width: 100%; height: auto; display: block;'>
                    </div>
                </a>
                """,
                unsafe_allow_html=True
